...
// Strefa klienta (każdy zalogowany użytkownik)
...
// Strefa kierownika i administratora
Route::middleware(['auth', 'role:kierownik|administrator'])->prefix('manage')->group(function () {
    ...
    // Zamówienia klientów (realizacja: kierownik i administrator)
